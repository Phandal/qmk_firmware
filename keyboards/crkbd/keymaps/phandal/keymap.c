...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LCTL(KC_SPC),    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,   LCTL(KC_W),
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          LM(1, MOD_LGUI),   KC_ENT,  MO(1),     LT(2,KC_BSPC),   KC_SPC, KC_RALT
                                      //`--------------------------'  `--------------------------'
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          LM(1, MOD_LGUI), KC_ENT,  KC_TRNS,     LT(3,KC_BSPC),   KC_SPC, KC_RALT
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          LM(1, MOD_LGUI),   KC_ENT,  MO(3),     KC_TRNS, KC_SPC, KC_RALT
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          LM(1, MOD_LGUI), KC_ENT, KC_TRNS,     KC_TRNS, KC_SPC, KC_RALT
                                      //`--------------------------'  `--------------------------'
  )
};
